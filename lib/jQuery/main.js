...
$('.addItem').click(function () {
    ...
    '</td>' +
		...
		'   <button class="removeProduct btn btn-danger"><i class="fas fa-trash-alt"></i></button>' +
	'	<button class="giftWrap btn btn-brown"><i class="fa fa-gift"></i></button>' +
		'</td>' +
		'</tr>'
	);
	}

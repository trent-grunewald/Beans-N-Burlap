...
// var coffee = [
//   {coffee: 'Brazil Minas Gerais', siz:'', pic:''},
//   {coffee: 'Sulawesi-Kalosi', siz:'', pic:''},
//   {coffee: 'Arabian Mocha-Java', siz:'', pic:''},
//   {coffee: 'Ethiopian Guji', siz:'', pic:''},
//   {coffee: 'Arabian Mocha Sanani', siz:'', pic:''},
//   {coffee: 'Sumatra Aceh Tengah', siz:'', pic:''},
//   {coffee: 'Kopi Luwak', siz:'', pic:''},
//   {coffee: 'Kona', siz:'', pic:''},
//   {coffee: 'Costa Rican Tarrazu', siz:'', pic:''},
// ]

var arr = document.querySelectorAll('.addItem');

$('.addItem').click(function(i, obj){
  for (var i = 0; i < arr.length; i++) {
    var test = document.querySelectorAll('.card-title');
    var des = document.querySelectorAll('.coffeeDesc');

    console.log($(des[i]).text());
}
  // {
  //   //looks at the input value of all ".qty" fields
  //     var value = Number($(this).val());
  ...
  //     if (!isNaN(value)) sum += value;
  // });
  //   var pos = $('.coffeeTitle').each();
  //   var pic = $('#coffee1 #coffeePic1').attr('src');
  //   var des = $('.card-text').text();
  //   var cnt = $('.qty').val();
  //   var siz = $('.size').val();
  //   $('#cart').find('#cartProduct').html(this.pos);

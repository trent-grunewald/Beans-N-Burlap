...
// $(".addItemItem").click(function() {
//   //targets the user input QTY
//     // var itemCount = $(".cartInput").find(".qty").val();
//     var itemCount = $(".qty").val();
//     //prevents adding 0 to cart
//       if ($(".qty").val() > 0) {
//         //updates the cart count if it is more than 0
//     $(".itemCount").html(itemCount);
//     //prevents page refresh
//       return false;
//   }else {
//     //prevents page refrehs on null submit
//     return false;
//   }
// });

...
$('.addItem').click(function(e) {
  ...
  // $('#cart').find('#cartPic').html('<div class="col-sm-2 hidden-xs" id="cartPic"><img src=' + pic + ' alt="..." class="cart-img"/></div>');
   $('.modalCart').append(
    ...
    '</td>'+
    '<td data-th="Size">'+
    '   <select id="cartSize" class="size form-control is-valid" placeholder="12oz" value="'+ siz +'" required>'+
    '      <option value="12oz" class="size" id="12oz"><span class="test">12oz</span></option>'+
    ...
    '<td data-th="Quantity">'+
    '   <input type="number"'+
    '      id="cartQty" class="form-control text-center" value="'+ qty +'">'+
    '</td>'+
    '<td class="actions" data-th="">'+
    '   <button class="btn btn-brown btn-sm"><i class="fas fa-sync-alt"></i></button>'+
